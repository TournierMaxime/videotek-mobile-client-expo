...
const LikesComments = ({ commentId, likes }) => {
  ...
  const handleCreate = async () => {
    await dispatch(createLike({ commentId }))
    setIsLiked(true)
  ...
  const handleDelete = async () => {
    try {
      ...
      const res = await dispatch(getOneLikeComment(userId, commentId))
  ...
  useEffect(() => {
    ...
    fetchLikeStatus()
  }, [dispatch, userId, commentId, isAuthenticated])
